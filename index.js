...
// Rotate text on x axis -  http://bl.ocks.org/phoebebright/3061203
//chart2.selectAll(".y.baraxis text")  // select all the text elements for the xaxis
//.attr("transform", function(d) {
//  return "translate(" + this.getBBox().height*-2 + "," + this.getBBox().width/2 + ")rotate(0)";
//});
...
chart2.append("text")
    .attr("text-anchor", "middle")  // this makes it easy to centre the text as the transform is applied to the anchor
    .attr("transform", "translate("+ (barWidth2/2) +","+(barHeight2-(barMargin2.bottom - 150))+")")  // centre below axis
